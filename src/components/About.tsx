  ...
  return (
    <section className="lg:pt-25 pt-15">
      <div className="container mx-auto">
        <div
          className="lg:w-[80%] w-full text-center mx-auto bg-black lg:py-[70px] lg:px-20 py-10 px-10 lg:rounded-[40px] rounded-[30px] fadeInUp"
          data-delay="0.2"
          style={{
            translate: "none",
            rotate: "none",
        ...
        >
          <h3 className="md:text-3xl md:leading-[48px] text-2xl leading-9 text-white">
            Designpro took my billion-dollar baby idea, slapped their design
            magic on it, and boom –
